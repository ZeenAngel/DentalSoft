    ...
    public partial class DataSetFactura : global::System.Data.DataSet {
        ...
        public partial class FacturaDataTable : global::System.Data.TypedTableBase<FacturaRow> {
            ...
            private void InitClass() {
                ...
                this.columnNum_factura.MaxLength = 16;
                ...
                this.columnPresupuesto.MaxLength = 19;
                this.columnNIF.AllowDBNull = false;
                this.columnNIF.MaxLength = 13;
        ...
        public partial class FacturaRow : global::System.Data.DataRow {
            ...
            public string CP {
                get {
                    return ((string)(this[this.tableFactura.CPColumn]));
                }
                set {
                    this[this.tableFactura.CPColumn] = value;
                }
            }
            ...
            public string Apellido2 {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("El valor de la columna \'Apellido2\' de la tabla \'Factura\' es DBNull.", e);
                    }
                }
                set {
            ...
            public string Presupuesto {
                get {
                    try {
                        return ((string)(this[this.tableFactura.PresupuestoColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("El valor de la columna \'Presupuesto\' de la tabla \'Factura\' es DBNull.", e);
                    }
                }
                set {
                    this[this.tableFactura.PresupuestoColumn] = value;
                }
            }
            ...
            public string Tratamiento {
                get {
                    return ((string)(this[this.tableFactura.TratamientoColumn]));
                }
                set {
                    this[this.tableFactura.TratamientoColumn] = value;
                }
            }
            ...
            public float Precio {
                get {
                    return ((float)(this[this.tableFactura.PrecioColumn]));
                }
                set {
            ...
            public bool IsPresupuestoNull() {
                return this.IsNull(this.tableFactura.PresupuestoColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetPresupuestoNull() {
                this[this.tableFactura.PresupuestoColumn] = global::System.Convert.DBNull;
            }
...
namespace DentalSoft.Datos.DataSetFacturaTableAdapters {
    ...
    public partial class FacturaTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = @"SELECT        factura.Num_factura, factura.Fecha, factura.Nif_centro AS NIF, factura.Nombre_centro AS Centro, factura.Direccion, factura.Localidad, factura.CP, factura.Telefono, factura.Dni_paciente AS DNI, 
...
WHERE        factura.Num_factura = detalle_factura.Factura AND detalle_factura.Tratamiento = tratamiento.Id";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.Odbc.OdbcCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = @"SELECT        factura.Num_factura, factura.Fecha, factura.Nif_centro AS NIF, factura.Nombre_centro AS Centro, factura.Direccion, factura.Localidad, factura.CP, factura.Telefono, factura.Dni_paciente AS DNI, 
                         factura.Nombre_paciente AS Nombre, factura.Apellido1, factura.Apellido2, factura.Presupuesto, detalle_factura.Id, tratamiento.Nombre AS Tratamiento, detalle_factura.Cantidad, detalle_factura.Precio, 
                         detalle_factura.Cantidad * detalle_factura.Precio AS Subtotal
FROM            factura, detalle_factura, tratamiento
WHERE        factura.Num_factura = detalle_factura.Factura AND detalle_factura.Tratamiento = tratamiento.Id AND (factura.Num_factura = ?)";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.Odbc.OdbcParameter("Num_factura", global::System.Data.Odbc.OdbcType.NVarChar, 1024, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "Num_factura", global::System.Data.DataRowVersion.Current, false, null));
            this._commandCollection[2] = new global::System.Data.Odbc.OdbcCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = @"SELECT        factura.Num_factura, factura.Fecha, factura.Nif_centro AS NIF, factura.Nombre_centro AS Centro, factura.Direccion, factura.Localidad, factura.CP, factura.Telefono, factura.Dni_paciente AS DNI, 
                         factura.Nombre_paciente AS Nombre, factura.Apellido1, factura.Apellido2, factura.Presupuesto, detalle_factura.Id, tratamiento.Nombre AS Tratamiento, detalle_factura.Cantidad, detalle_factura.Precio, 
                         detalle_factura.Cantidad * detalle_factura.Precio AS Subtotal
FROM            factura, detalle_factura, tratamiento
WHERE        factura.Num_factura = detalle_factura.Factura AND detalle_factura.Tratamiento = tratamiento.Id AND (factura.Fecha = ?)";
            ...
            this._commandCollection[3].CommandText = @"SELECT        factura.Num_factura, factura.Fecha, factura.Nif_centro AS NIF, factura.Nombre_centro AS Centro, factura.Direccion, factura.Localidad, factura.CP, factura.Telefono, factura.Dni_paciente AS DNI, 
                         factura.Nombre_paciente AS Nombre, factura.Apellido1, factura.Apellido2, factura.Presupuesto, detalle_factura.Id, tratamiento.Nombre AS Tratamiento, detalle_factura.Cantidad, detalle_factura.Precio, 
                         detalle_factura.Cantidad * detalle_factura.Precio AS Subtotal
FROM            factura, detalle_factura, tratamiento
WHERE        factura.Num_factura = detalle_factura.Factura AND detalle_factura.Tratamiento = tratamiento.Id AND (factura.Dni_paciente = ?)";
            this._commandCollection[3].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[3].Parameters.Add(new global::System.Data.Odbc.OdbcParameter("Dni_paciente", global::System.Data.Odbc.OdbcType.NVarChar, 1024, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "DNI", global::System.Data.DataRowVersion.Current, false, null));
        }
        ...
        public virtual int FillByFactura(DataSetFactura.FacturaDataTable dataTable, string Num_factura) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((Num_factura == null)) {
                throw new global::System.ArgumentNullException("Num_factura");
            }
            else {
                this.Adapter.SelectCommand.Parameters[0].Value = ((string)(Num_factura));
            }
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        public virtual DataSetFactura.FacturaDataTable GetDataByFactura(string Num_factura) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((Num_factura == null)) {
                throw new global::System.ArgumentNullException("Num_factura");
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillByFecha(DataSetFactura.FacturaDataTable dataTable, System.DateTime Fecha) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual DataSetFactura.FacturaDataTable GetDataByFecha(System.DateTime Fecha) {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            this.Adapter.SelectCommand.Parameters[0].Value = ((System.DateTime)(Fecha));
            DataSetFactura.FacturaDataTable dataTable = new DataSetFactura.FacturaDataTable();
            this.Adapter.Fill(dataTable);
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillByPaciente(DataSetFactura.FacturaDataTable dataTable, string Dni_paciente) {
            this.Adapter.SelectCommand = this.CommandCollection[3];
            if ((Dni_paciente == null)) {
                throw new global::System.ArgumentNullException("Dni_paciente");
            }
            else {
                this.Adapter.SelectCommand.Parameters[0].Value = ((string)(Dni_paciente));
            }
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual DataSetFactura.FacturaDataTable GetDataByPaciente(string Dni_paciente) {
            this.Adapter.SelectCommand = this.CommandCollection[3];
            if ((Dni_paciente == null)) {
                throw new global::System.ArgumentNullException("Dni_paciente");
            }
