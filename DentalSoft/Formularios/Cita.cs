...
namespace DentalSoft
{
    public partial class Cita : Form
    {
        ...
        public Cita(MenuPrincipal formularioPadre)
        {
            InitializeComponent();
        ...
        private void AsignarPrivilegios()
        {
            if (empleado.Puesto == 3 || empleado.Puesto == 4)
            {
                ...
                btnEditarAgenda.Visible = false;
                btnEliminarAgenda.Visible = false;
            }
        }
        #endregion
        ...
        {
            if(empleado.Puesto != 2 && empleado.Puesto != 4) // Evita que el administrativo o la auxiliar puedan abrir el tratamiento del paciente
            {
        ...
        {
            RecordarCita recordarCita = new RecordarCita();
            recordarCita.ShowDialog();
        }
        #endregion
    }
}
